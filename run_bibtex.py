import numpy as np
from Utils.load_data import load_bibtex
...
print('Results obtained with IOKR on Bibtex dataset: ')
...
print('Results obtained with SIOKR on Bibtex dataset: ')
...
# Hyperparameters priorly obtained by inner 5-folds cv
best_L_ISOKR = 1e-05
best_sx_ISOKR = 10000.0
best_sy_ISOKR = 1000000.0
...
print('Results obtained with ISOKR on Bibtex dataset: ')
print('Test F1 score: ' + str(f1_mean) + ' +- ' + str(f1_std))
print('Training time (in seconds): ' + str(fit_time_mean) + ' +- ' + str(fit_time_std))
print('Inference time (in seconds): ' + str(decode_time_mean) + ' +- ' + str(decode_time_std))
print('\n')
...
print('Results obtained with SISOKR on Bibtex dataset: ')
print('Test F1 score: ' + str(f1_mean) + ' +- ' + str(f1_std))
print('Training time (in seconds): ' + str(fit_time_mean) + ' +- ' + str(fit_time_std))
print('Inference time (in seconds): ' + str(decode_time_mean) + ' +- ' + str(decode_time_std))
print('\n')